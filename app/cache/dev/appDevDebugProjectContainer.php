...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app_roles_helper' => 'getAppRolesHelperService',
            ...
            'language.change' => 'getLanguage_ChangeService',
            'locale_listener' => 'getLocaleListenerService',
            'logger' => 'getLoggerService',
            'media.interface' => 'getMedia_InterfaceService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \HarasBundle\Controller\ExceptionController A HarasBundle\Controller\ExceptionController instance
     */
    protected function getApp_ExceptionControllerService()
    {
        return $this->services['app.exception_controller'] = new \HarasBundle\Controller\ExceptionController($this->get('twig'), true);
    }
    ...
    {
        return $this->services['app.form.registration'] = new \UserBundle\Form\RegistrationType('UserBundle\\Entity\\User', $this->get('app_roles_helper'));
    }

    /**
     * Gets the 'app_roles_helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\Services\RolesHelper A UserBundle\Services\RolesHelper instance
     */
    protected function getAppRolesHelperService()
    {
        return $this->services['app_roles_helper'] = new \UserBundle\Services\RolesHelper(array('ROLE_USER' => array(0 => 'ROLE_USER'), 'ROLE_MODERATEUR' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_MODERATEUR', 1 => 'ROLE_USER', 2 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'haras', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/HarasBundle/Resources/config/doctrine') => 'HarasBundle\\Entity', ($this->targetDirs[3].'/src/PlateFormeBundle/Resources/config/doctrine') => 'PlateFormeBundle\\Entity', ($this->targetDirs[3].'/src/UserBundle/Resources/config/doctrine') => 'UserBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'HarasBundle\\Entity');
        $b->addDriver($a, 'PlateFormeBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('HarasBundle' => 'HarasBundle\\Entity', 'PlateFormeBundle' => 'PlateFormeBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_020951411e2d030fae54f5f1e1eaae2e9e3cca624f81e881ffbbcdca305a4940');
    ...
    protected function getIvoryCkEditor_ConfigManagerService()
    {
        ...
        $instance->setConfig('my_config', array('toolbar' => array(0 => array(0 => 'Preview'), 1 => array(0 => 'Cut', 1 => 'Copy', 2 => 'Paste', 3 => 'PasteText', 4 => 'PasteFromWord', 5 => '-', 6 => 'Undo', 7 => 'Redo'), 2 => array(0 => 'Find', 1 => 'Replace', 2 => '-', 3 => 'SelectAll', 4 => '-', 5 => 'SpellChecker', 6 => 'Scayt'), 3 => '/', 4 => array(0 => 'Bold', 1 => 'Italic', 2 => 'Underline', 3 => 'Strike', 4 => 'Blockquote', 5 => 'Subscript', 6 => 'Superscript', 7 => '-', 8 => 'RemoveFormat'), 5 => array(0 => 'NumberedList', 1 => 'BulletedList', 2 => '-', 3 => 'Outdent', 4 => 'Indent', 5 => '-', 6 => '-', 7 => 'JustifyLeft', 8 => 'JustifyCenter', 9 => 'JustifyRight', 10 => 'JustifyBlock'), 6 => array(0 => 'Link', 1 => 'Unlink', 2 => 'Anchor'), 7 => array(0 => 'pbckcode', 1 => 'Image', 2 => 'Video', 3 => 'Table', 4 => 'SpecialChar', 5 => 'Iframe'), 8 => '/', 9 => array(0 => 'Styles', 1 => 'Format', 2 => 'Font', 3 => 'FontSize'), 10 => array(0 => 'TextColor', 1 => 'BGColor'), 11 => array(0 => 'RemoveFormat'), 12 => array(0 => 'Maximize')), 'language' => 'fr', 'uiColor' => NULL));
    ...
    /**
     * Gets the 'language.change' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HarasBundle\Services\languageChange A HarasBundle\Services\languageChange instance
     */
    protected function getLanguage_ChangeService()
    {
        return $this->services['language.change'] = new \HarasBundle\Services\languageChange();
    }
    ...
    /**
     * Gets the 'media.interface' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HarasBundle\Services\mediaInterface A HarasBundle\Services\mediaInterface instance
     */
    protected function getMedia_InterfaceService()
    {
        return $this->services['media.interface'] = new \HarasBundle\Services\mediaInterface($this);
    }
    ...
    {
        return $this->services['redirect.after.logout'] = new \UserBundle\Redirection\AfterLogoutRedirection($this->get('router'), $this->get('security.context'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/plateforme/admin/user');
        ...
        $n = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $m, $this->get('redirect.after.logout'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'fos_user_security_logout'));
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage(array('cookie_httponly' => true, 'gc_probability' => 0), NULL, $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/HarasBundle/Resources/views'), 'Haras');
        ...
        $instance->addPath(($this->targetDirs[3].'/src/PlateFormeBundle/Resources/views'), 'PlateForme');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(0 => 'ROLE_USER'), 'ROLE_MODERATEUR' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_MODERATEUR', 1 => 'ROLE_USER', 2 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'HarasBundle' => 'HarasBundle\\HarasBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'MobileDetectBundle' => 'SunCat\\MobileDetectBundle\\MobileDetectBundle',
                'PlateFormeBundle' => 'PlateFormeBundle\\PlateFormeBundle',
            ...
            'locale' => 'fr',
            'medias_directory' => ($this->targetDirs[2].'/../src/HarasBundle/Resources/public/media'),
            'web_directory' => ($this->targetDirs[2].'/../web/'),
            'articles_per_page' => 5,
