 ...
 */
class Media extends \HarasBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'HarasBundle\\Entity\\Media' . "\0" . 'file', '' . "\0" . 'HarasBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'HarasBundle\\Entity\\Media' . "\0" . 'name', '' . "\0" . 'HarasBundle\\Entity\\Media' . "\0" . 'path', '' . "\0" . 'HarasBundle\\Entity\\Media' . "\0" . 'alt', '' . "\0" . 'HarasBundle\\Entity\\Media' . "\0" . 'pages'];
        }
    ...
    public function setFile($rondoudou)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFile', [$rondoudou]);

        return parent::setFile($rondoudou);
    }
    ...
    public function getMediaTranslation($language)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMediaTranslation', [$language]);

        return parent::getMediaTranslation($language);
    }
    ...
    public function addPage(\HarasBundle\Entity\Page $pages)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPage', [$pages]);
    ...
    public function removePage(\HarasBundle\Entity\Page $pages)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removePage', [$pages]);
