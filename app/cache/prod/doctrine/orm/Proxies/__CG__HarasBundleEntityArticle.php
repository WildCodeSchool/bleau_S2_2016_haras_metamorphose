 ...
 */
class Article extends \HarasBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'HarasBundle\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'HarasBundle\\Entity\\Article' . "\0" . 'name', '' . "\0" . 'HarasBundle\\Entity\\Article' . "\0" . 'title', '' . "\0" . 'HarasBundle\\Entity\\Article' . "\0" . 'content', '' . "\0" . 'HarasBundle\\Entity\\Article' . "\0" . 'medias', '' . "\0" . 'HarasBundle\\Entity\\Article' . "\0" . 'pages', '' . "\0" . 'HarasBundle\\Entity\\Article' . "\0" . 'structure', '' . "\0" . 'HarasBundle\\Entity\\Article' . "\0" . 'createdAt'];
        }
